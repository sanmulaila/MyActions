...
$.inviteCodeList = ['g_eiitD1h9-a-PX-GytKiGrfw77E3iG0LpMlIb2JHcbWJNrG9hUp_ANPttQxg7pzubkcuRdb7lxeLs3ZSZ9h4w', 
    'g_eiitD1h9-a-PX-GytKiGrfw77E3iG0LpMlIb2JHcZxX4bMLtrmBLs0VPBzV3_4OIlP7KB9xpyYy8R_kjaYFQ', 
    'g_eiitD1h9-a-PX-GytKiGrfw77E3iG0LpMlIb2JHca71qD5t1s_IAlCSx4dvqjkYLkmGlplDCYST1P6jpjzrw', 
    'g_eiitD1h9-a-PX-GytKiGrfw77E3iG0LpMlIb2JHcaR-wy9EI6__CefgNLERYoNsIckgOQUOC_TVPh7zmJbcw'
];
let cookiesArr = [];
$.appId = 10028;
$.helpCkList = [];
    ...
    try {
        ...
        if (Number($.homeInfo.coins) > 5000) {
            ...
            if (Number(materialNumber) < 6600) {
                ...
                console.log(`现有白菜${materialNumber},大于 6600 颗,不进行购买`);
            }
        } else {
            console.log(`\n共有金币${$.homeInfo.coins}`);
        }
